...
#define kDotaProgramListURLOffSet @"http://api.dotaly.com/api/v1/shipin/latest?author=%@&iap=0&ident=D0C9716C-247F-4B2D-BEFC-F586482D2A01&jb=0&limit=50&offset=%ld"
